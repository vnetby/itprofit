<? get_header();
global $wp_query;
$c = get_term_by('id', $wp_query->query_vars['tag_id'], 'post_tag');
?>
<main>
                ...
                <div class="categories__item">
                    ...
                    <div class="categories__wrapper flex__start flex__wrap posts">
                        ...
                        foreach ($categories as $cat): ?>
                            <a href="/portfolio/<?= $cat->slug ?>" data-type="cat" data-id="<?= $cat->term_id ?>"><?= $cat->name ?></a>
                        <? endforeach; ?>
                    </div>
                </div>
                <div class="categories__item">
                    ...
                    <div class="categories__wrapper flex__start flex__wrap posts">
                        ...
                        foreach ($tags as $tag): ?>
                            <a <? if($tag->term_id == $c->term_id): ?>class="active"<? endif; ?>
                                    href="<?= $tag->slug ?>"
                                    data-type="tag"
                                    data-id="<?= $tag->term_id ?>"
                            ><?= $tag->name ?></a>
